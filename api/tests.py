...
class UserAPITest(APITestCase):
    ...
    def test_access_token_refresh_invalid_token(self):
        ...
        self.assertEqual(response.data["error"], "Invalid token or expired refresh token")
    ...
    def test_access_token_expiry(self):
        ...
        response = self.client.get(self.me_url, HTTP_AUTHORIZATION=f'Bearer {access_token}')
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
